About types-aiobotocore-batch-feedstock
=======================================
...
Summary: Type annotations for aiobotocore.Batch 3.9.1 service generated with mypy-boto3-builder
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/types-aiobotocore-batch-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/types-aiobotocore-batch-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add types-aiobotocore-batch
# for installing globally
pixi global install types-aiobotocore-batch
```
...
It is possible to list all of the versions of `types-aiobotocore-batch` available on your platform:
...
```
pixi search types-aiobotocore-batch --channel conda-forge
```
